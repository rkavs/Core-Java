...
public class HtmlUnitDriverConcept {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// htmlunitdriver -- to use this concept, we have to download htmlunitdriver JAR
		// file.
		...
		// script
		// 3. not suitable for Actions class -- user actions -- mousemovement,
		// doubleClick, drag and drop
